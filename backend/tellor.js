let database = {
  group1: [
    ...
    {
      deadline: "26-02-2021",
      content: "Buat template untuk display dan data awal",
      index: 1,
    },
  ],
  group2: [],
  group3: [
    {
      deadline: "26-02-2021",
      content: "Siapin materi untuk presentasi",
      index: 2,
    },
  ],
  group4: [],
...
function render(groupPost) {
  ...
  for (let n = 0; n < database[groupPost].length; n++) {
    ...
    if (groupPost !== "group4") postOption.appendChild(buttonMove);
...
for (let postGroup in database) render(postGroup);
...
document
  .getElementById("postNewPostButton")
